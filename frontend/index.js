      ...
      return function (action) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Affjax.get(Affjax_ResponseFormat.string)("http://localhost:9009/home")))(function (res) {
              ...
              if (res instanceof Data_Either.Right) {
                  ...
                  throw new Error("Failed pattern match at Components.Home (line 110, column 11 - line 121, column 51): " + [ v.constructor.name ]);
              };
              throw new Error("Failed pattern match at Components.Home (line 106, column 7 - line 121, column 51): " + [ res.constructor.name ]);
          });
      };
  };
  var component = function (dictMonadAff) {
              ...
              return function (dictLogMessages) {
                  return function (dictNavigate) {
                      var render = function (v) {
                          ...
                          throw new Error("Failed pattern match at Components.Router (line 119, column 37 - line 143, column 61): " + [ v.route.constructor.name ]);
                      };
                      var handleQuery = function (v) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Data_Maybe.eqMaybe(Route.eqRoute))(v1.route)(new Data_Maybe.Just(v.value0)))((function () {
                                  var v2 = Data_Maybe.isJust(v1.currentUser) && Data_Foldable.elem(Data_Foldable.foldableArray)(Route.eqRoute)(v.value0)([ Route.Home.value ]);
                                  if (!v2) {
                      ...
                      var handleAction = function (v) {
                          ...
                          throw new Error("Failed pattern match at Components.Router (line 85, column 20 - line 93, column 50): " + [ v.constructor.name ]);
                      };
