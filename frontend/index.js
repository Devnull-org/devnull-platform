...
(function($PS) {
  ...
  var Pathy_Sandboxed = $PS["Pathy.Sandboxed"];
  var DownloadingContent = (function () {
      function DownloadingContent() {

      };
      DownloadingContent.value = new DownloadingContent();
      return DownloadingContent;
  })();
  var ReceivedContent = (function () {
      function ReceivedContent(value0) {
          this.value0 = value0;
      };
      ReceivedContent.create = function (value0) {
          return new ReceivedContent(value0);
      };
  ...
  var handleAction = function (dictMonadAff) {
      return function (action) {
          if (action instanceof DownloadingContent) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Affjax.get(Affjax_ResponseFormat.string)("http://localhost:9009/home")))(function (response) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $12.loading = false;
                      $12.content = Data_Maybe.fromMaybe("")(Data_Functor.map(Data_Maybe.functorMaybe)(function (v1) {
                          return v1.body;
          ...
          if (action instanceof ReceivedContent) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var $15 = {};
                  for (var $16 in st) {
                  ...
                  $15.loading = false;
                  $15.content = action.value0;
                  return $15;
              });
          };
          throw new Error("Failed pattern match at Components.Home (line 94, column 3 - line 102, column 13): " + [ action.constructor.name ]);
      };
  };
  var homeComponent = function (dictMonadAff) {
