...
(function($PS) {
  ...
  var main = Data_Functor["void"](Effect.functorEffect)(Effect_Aff.launchAff(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
      method: new Data_Either.Left(Data_HTTP_Method.GET.value),
      ...
      if (result instanceof Data_Either.Left) {
          return Effect_Class_Console.log(Effect_Aff.monadEffectAff)("GET / response failed to decode: " + Affjax.printError(result.value0));
      };
      if (result instanceof Data_Either.Right) {
          return Effect_Class_Console.log(Effect_Aff.monadEffectAff)("GET / response: " + Data_Argonaut_Core.stringify(result.value0.body));
      };
      throw new Error("Failed pattern match at Main (line 24, column 3 - line 26, column 76): " + [ result.constructor.name ]);
  })));
  exports["main"] = main;
})(PS);
PS["Main"].main();