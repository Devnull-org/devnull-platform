...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Classes.LogMessages"] = $PS["Classes.LogMessages"] || {};
  var exports = $PS["Classes.LogMessages"];
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Classes.Navigate"] = $PS["Classes.Navigate"] || {};
  var exports = $PS["Classes.Navigate"];
  var Control_Monad_Trans_Class = $PS["Control.Monad.Trans.Class"];
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Classes.Now"] = $PS["Classes.Now"] || {};
  var exports = $PS["Classes.Now"];                                          
...
(function($PS) {
  ...
  var Developers = (function () {
      ...
      Developers.value = new Developers();
      return Developers;
  })(); 
  var genericRoute = new Data_Generic_Rep.Generic(function (x) {
      ...
      if (x instanceof Developers) {
          return new Data_Generic_Rep.Inr(Data_Generic_Rep.NoArguments.value);
      };
      throw new Error("Failed pattern match at Route (line 43, column 1 - line 43, column 48): " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var routeCodec = Routing_Duplex.root(Routing_Duplex_Generic.sum(genericRoute)(Routing_Duplex_Generic.gRouteSum(Routing_Duplex_Generic.gRouteConstructor(new Data_Symbol.IsSymbol(function () {
      ...
      Developers: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("developers")(Routing_Duplex_Generic.noArgs)
  }));   
  var eqRoute = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof Developers && y instanceof Developers) {
              return true;
          };
          return false;
      };
...
(function($PS) {
  ...
  $PS["AppM"] = $PS["AppM"] || {};
  var exports = $PS["AppM"];
  var Classes_LogMessages = $PS["Classes.LogMessages"];
  var Classes_Navigate = $PS["Classes.Navigate"];
  var Classes_Now = $PS["Classes.Now"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Reader_Class = $PS["Control.Monad.Reader.Class"];
  var Control_Monad_Reader_Trans = $PS["Control.Monad.Reader.Trans"];
  ...
  var nowAppM = new Classes_Now.Now(function () {
      return monadAppM;
  ...
  var logMessagesAppM = new Classes_LogMessages.LogMessages(function () {
      return monadAppM;
  }, function (log) {
      return Control_Bind.bind(bindAppM)(Control_Monad_Reader_Class.ask(monadAskAppM(Type_Equality.refl)))(function (env) {
          return Effect_Class.liftEffect(monadEffectAppM)((function () {
              var v = Log.reason(log);
              if (env.logLevel instanceof Env.Prod && v instanceof Log.Debug) {
                  return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
              };
              return Effect_Console.log(Log.message(log));
          })());
      });
  });
  var navigateAppM = new Classes_Navigate.Navigate(function () {
      return monadAppM;
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(bindAppM)(Effect_Class.liftEffect(monadEffectAppM)(function __do() {
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(bindAppM)(Effect_Aff_Class.liftAff(monadAffAppM)(Effect_Aff_Bus.write(Data_Maybe.Nothing.value)(v.userBus)))(function () {
              return Classes_Navigate.navigate(navigateAppM)(Route.Home.value);
          });
      });
  }), (function () {
      var $15 = Effect_Class.liftEffect(monadEffectAppM);
      var $16 = Routing_Duplex.print(Route.routeCodec);
      return function ($17) {
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Components.Developers"] = $PS["Components.Developers"] || {};
  var exports = $PS["Components.Developers"];
  ...
  var renderDev = function (devResponse) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row border m-4 p-4") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col-xs-6 w-50") ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Username: ") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col-xs-6 w-50") ])([ Halogen_HTML_Elements.h5_([ Halogen_HTML_Core.text(devResponse.userResponseUserName) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col-xs-6 w-50") ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("First Name: ") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col-xs-6 w-50") ])([ Halogen_HTML_Elements.h5_([ Halogen_HTML_Core.text(devResponse.userResponseUserFirstName) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col-xs-6 w-50") ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Last Name: ") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col-xs-6 w-50") ])([ Halogen_HTML_Elements.h5_([ Halogen_HTML_Core.text(devResponse.userResponseUserLastName) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col-xs-6 w-50") ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Email: ") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col-xs-6 w-50") ])([ Halogen_HTML_Elements.h5_([ Halogen_HTML_Core.text(devResponse.userResponseUserEmail) ]) ]) ]);
  };
  var ui = function (st) {
      ...
      var devList = Halogen_HTML_Elements.div_(Data_Functor.map(Data_Functor.functorArray)(renderDev)(st.content));
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("container") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("jumbothron text-center") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src(stringPath) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("container bg-white p-5") ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Developers") ]), Halogen_HTML_Elements.div_([ devList ]) ]) ]);
  };
  ...
  var handleAction = function (dictMonadAff) {
      return function (action) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Affjax.get(Affjax_ResponseFormat.string)("http://localhost:9009/developers")))(function (res) {
              if (res instanceof Data_Either.Left) {
                  return Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("GET /developers response failed to decode: " + Affjax.printError(res.value0));
              };
              if (res instanceof Data_Either.Right) {
                  var v = Simple_JSON.readJSON(Simple_JSON.readArray(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                      return "userResponseUserEmail";
                  }))(Simple_JSON.readString)(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                      return "userResponseUserFirstName";
                  }))(Simple_JSON.readString)(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                      return "userResponseUserLastName";
                  }))(Simple_JSON.readString)(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                      return "userResponseUserName";
                  }))(Simple_JSON.readString)(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                      return "userResponseUserRole";
                  }))(Simple_JSON.readString)(Simple_JSON.readFieldsNil)()())()())()())()())()())))(res.value0.body);
                  if (v instanceof Data_Either.Right) {
                  ...
                  if (v instanceof Data_Either.Left) {
                      return Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("Can't parse JSON. " + Data_Show.show(Data_List_Types.showNonEmptyList(Foreign.showForeignError))(v.value0));
                  };
                  throw new Error("Failed pattern match at Components.Developers (line 122, column 11 - line 131, column 51): " + [ v.constructor.name ]);
              };
              throw new Error("Failed pattern match at Components.Developers (line 118, column 7 - line 131, column 51): " + [ res.constructor.name ]);
          });
      };
  };
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Components.EventSource"] = $PS["Components.EventSource"] || {};
  var exports = $PS["Components.EventSource"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Rec_Class = $PS["Control.Monad.Rec.Class"];
  var Effect_Aff = $PS["Effect.Aff"];
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Components.EnvironmentGlue"] = $PS["Components.EnvironmentGlue"] || {};
  var exports = $PS["Components.EnvironmentGlue"];
  var Components_EventSource = $PS["Components.EventSource"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Reader_Class = $PS["Control.Monad.Reader.Class"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Functor = $PS["Data.Functor"];
          ...
          return function (dictLacks) {
              return function (innerComponent) {
                  ...
                  var handleAction = function (v) {
                      ...
                      throw new Error("Failed pattern match at Components.EnvironmentGlue (line 60, column 18 - line 80, column 21): " + [ v.constructor.name ]);
                  };
                  return Halogen_Component.mkComponent({
...
(function($PS) {
  ...
  var DownloadContent = (function () {
      ...
      DownloadContent.value = new DownloadContent();
  ...
  var handleAction = function (dictMonadAff) {
      return function (action) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Affjax.get(Affjax_ResponseFormat.string)("http://localhost:9009/home")))(function (res) {
              if (res instanceof Data_Either.Left) {
                  return Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("GET /home response failed to decode: " + Affjax.printError(res.value0));
              };
              if (res instanceof Data_Either.Right) {
                  var v = Simple_JSON.readJSON(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                      return "homeResponseAdditionalText";
                  }))(Simple_JSON.readString)(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                      return "homeResponseMainText";
                  }))(Simple_JSON.readString)(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                      return "homeResponseTitle";
                  }))(Simple_JSON.readString)(Simple_JSON.readFieldsNil)()())()())()()))(res.value0.body);
                  if (v instanceof Data_Either.Right) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          var $13 = {};
                          ...
                          $13.loading = false;
                          $13.title = v.value0.homeResponseTitle;
                          $13.mainText = v.value0.homeResponseMainText;
                          $13.additionalText = v.value0.homeResponseAdditionalText;
                          return $13;
                      });
                  };
                  if (v instanceof Data_Either.Left) {
                  ...
                  throw new Error("Failed pattern match at Components.Home (line 108, column 11 - line 119, column 51): " + [ v.constructor.name ]);
              };
              throw new Error("Failed pattern match at Components.Home (line 104, column 7 - line 119, column 51): " + [ res.constructor.name ]);
          });
      };
  };
  var component = function (dictMonadAff) {
      return Halogen_Component.mkComponent({
          ...
          "eval": Halogen_Component.mkEval({
              ...
              handleQuery: Halogen_Component.defaultEval.handleQuery,
              receive: Halogen_Component.defaultEval.receive,
              initialize: new Data_Maybe.Just(DownloadContent.value),
              finalize: Halogen_Component.defaultEval.finalize
          })
      });
  };
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Components.Router"] = $PS["Components.Router"] || {};
  var exports = $PS["Components.Router"];
  var Classes_Navigate = $PS["Classes.Navigate"];
  var Components_Developers = $PS["Components.Developers"];
  var Components_EnvironmentGlue = $PS["Components.EnvironmentGlue"];
                  ...
                  return function (dictNavigate) {
                      var render = function (v) {
                          if (v.route instanceof Data_Maybe.Just) {
                              if (v.route.value0 instanceof Route.Home) {
                                  return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                                      return "home";
                                  }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Components_Home.component(dictMonadAff))({})(Data_Void.absurd);
                              };
                              if (v.route.value0 instanceof Route.Developers) {
                                  return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                                      return "developers";
                                  }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Components_Developers.component(dictMonadAff))({
                                      redirect: true
                                  })(Data_Void.absurd);
                              };
                              throw new Error("Failed pattern match at Components.Router (line 121, column 17 - line 125, column 97): " + [ v.route.value0.constructor.name ]);
                          };
                          ...
                          throw new Error("Failed pattern match at Components.Router (line 120, column 37 - line 146, column 61): " + [ v.route.constructor.name ]);
                      };
                      var handleQuery = function (v) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Data_Maybe.eqMaybe(Route.eqRoute))(v1.route)(new Data_Maybe.Just(v.value0)))((function () {
                                  var v2 = Data_Maybe.isJust(v1.currentUser) && Data_Foldable.elem(Data_Foldable.foldableArray)(Route.eqRoute)(v.value0)([ Route.Home.value, Route.Developers.value ]);
                                  if (!v2) {
                                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                          ...
                                          $23.route = new Data_Maybe.Just(v.value0);
                                          return $23;
                                      });
                                  };
                      ...
                      var handleAction = function (v) {
                          if (v instanceof Initialize) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)((function () {
                                  var $38 = Routing_Duplex.parse(Route.routeCodec);
                                  return function ($39) {
                                      return Data_Either.hush($38($39));
                                  };
                                  ...
                                  return Classes_Navigate.navigate(Classes_Navigate.navigateHalogenM(dictNavigate))(Data_Maybe.fromMaybe(Route.Home.value)(initialRoute));
                              });
                          };
                          if (v instanceof Receive) {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          throw new Error("Failed pattern match at Components.Router (line 87, column 20 - line 95, column 50): " + [ v.constructor.name ]);
                      };
                      return Components_EnvironmentGlue.component(dictMonadAff)(dictMonadAsk)()(Halogen_Component.mkComponent({
                          ...
                          "eval": Halogen_Component.mkEval({
                              ...
                              handleQuery: handleQuery,
                              receive: function ($40) {
                                  return Data_Maybe.Just.create(Receive.create($40));
                              },
                              initialize: new Data_Maybe.Just(Initialize.value),
                              finalize: Halogen_Component.defaultEval.finalize
                          })
...
(function($PS) {
  ...
  var exports = $PS["Main"];
  var AppM = $PS["AppM"];
  var Components_Router = $PS["Components.Router"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Either = $PS["Data.Either"];
  var Data_Eq = $PS["Data.Eq"];
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Aff_Bus.make(Effect_Class.monadEffectEffect)))(function (userBus) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref["new"](Data_Maybe.Nothing.value)))(function (currentUser) {
              ...
              var rootComponent = Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(AppM.runAppM(environment))(Components_Router.component(AppM.monadAffAppM)(AppM.monadAskAppM(Type_Equality.refl))(AppM.nowAppM)(AppM.logMessagesAppM)(AppM.navigateAppM));
              return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(rootComponent)({})(body))(function (halogenIO) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Functor["void"](Effect_Aff.functorAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Routing_Hash.matchesWith(Data_Either.foldableEither)(Routing_Duplex.parse(Route.routeCodec))(function (old) {
                      return function ($$new) {
                          return Control_Applicative.when(Effect.applicativeEffect)(Data_Eq.notEq(Data_Maybe.eqMaybe(Route.eqRoute))(old)(new Data_Maybe.Just($$new)))(Effect_Aff.launchAff_(halogenIO.query(Halogen_Query.tell(Components_Router.Navigate.create($$new)))));
                      };
                  }))))(function () {
